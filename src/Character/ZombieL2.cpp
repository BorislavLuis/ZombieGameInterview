...
ZombieL2::ZombieL2(Transform* tf,int path):GameObject(tf)
{
    ...
    m_Collider->m_Circle.x = (int)m_Tf->X + m_Tf->m_Width/2 + 7;
...
void ZombieL2::Draw()
{
    ...
    int HealthScalled = Scaling(m_Health.GetHealth(),0,200,0,100);
...
void ZombieL2::ReciveDamage(int damage)
{
...
void ZombieL2::HandlePatrolState()
{

}

void ZombieL2::CreatePaths()
{
...
void ZombieL2::ApplyForceX(float a, float b)
{
    if(a < b)
    {
...
void ZombieL2::ApplyForceY(float a, float b)
{
    if(a < b)
    {
