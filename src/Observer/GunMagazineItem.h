#ifndef GUNMAGAZINEITEM_H
#define GUNMAGAZINEITEM_H

#include "Subject.h"

class GunMagazineItem: public Observer
{
    public:
        GunMagazineItem(Transform* tf, Collider* coll, SpriteAnimation* sp);
